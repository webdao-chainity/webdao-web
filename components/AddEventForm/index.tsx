        ...
        <div className="form_wrapper">
            ...
            <form>
                ...
                <div className="input_item">
                    ...
                    <div className="input_wrapper">
                        <textarea placeholder={'Enter description'} name='description' onChange={updateData}/>
                    </div>
                </div>
                {/*<div className="input_item">*/}
                ...
                <div className="input_item">
                    ...
                    <div className="input_wrapper">
                        <input type='number' placeholder={'Enter total capacity'} name='totalCap'
                               onChange={updateData} min={1}/>
                    </div>
                </div>
                <div className="input_item">
                    <div className="name_key">Min voter</div>
                    <div className="input_wrapper">
                        <input type='number' placeholder={'Enter min voter'} name='minVoter' onChange={updateData}
                               min={0}/>
                    </div>
                </div>
                <div className="input_item">
                    ...
                    <div className="input_wrapper">
                        <input type='number' placeholder={'Enter max voter'} name='maxVoter' min={1} onChange={updateData}/>
                    </div>
                </div>
                <div className="input_item">
                    <div className="name_key">Start time</div>
                    <div className="input_wrapper">
                        <input type='datetime-local' placeholder={'Enter start time'} name='startTime'
                               onChange={updateData}/>
                    </div>
                </div>
                <div className="input_item">
                    ...
                    <div className="input_wrapper">
                        <input type='datetime-local' placeholder={'Enter end time'} name='endTime'
                               onChange={updateData}/>
                    </div>
                </div>
            </form>
...
export const AddEventForm = withTheme(styled(AddEventFormComp)(() => {
    return css`
      .form_wrapper {
        padding: 2rem;
