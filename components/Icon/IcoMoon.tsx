import {createElement, CSSProperties, SVGProps, JSXElementConstructor} from 'react';
...
const IcoMoon = ({
  ...
  const computedStyle = {
    ...
    ...(size ? {width: size, height: size} : {width: 'inherit', height: 'inherit'}),
    ...(props.style || {}),
  };
  ...
  return createElement(SvgComponent || 'svg', {...props, viewBox, style: computedStyle}, children);
};
