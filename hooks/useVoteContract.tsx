...
const useVoteContract = (voteId: number | null, account: string | null | undefined) => {
    ...
    const connectContract = async () => {
        try {
            ...
            // @ts-ignore
            let contractToRead = new providerToRead.eth.Contract(VOTE_CONTRACT_ABI, VOTE_CONTRACT_ADDRESS);
    ...
    return {data, contract, hasVoted, handleVote, handleCancelVote, isFinished, lastVoted, handleCreateVoting};
};
